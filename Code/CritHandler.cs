...
namespace CritSounds
{
    public class StreamType
    {
        ...
        public class CritSfxHandler : ModPlayer
        {
            ...
            private const int Egg1SfxCount = 18;
            private const int MeleeStabCritsSfxCount = 4;
            private const int RangedCritsSfxCount = 5;
            private const int ThrowingCritsSfxCount = 4;
            private const int MagicCritsSfxCount = 4;
            private const int MeleeCritsSfxCount = 4;
            private const int SummonCritsSfxCount = 4;
            private const int GenericCritsSfxCount = 6;
            ...
            public override void OnHitNPC(Item item, NPC target, int damage, float knockback, bool crit)
            {
                ...
                if (crit && meleeStabCritsEnabled && item.type != ItemID.TheAxe)
                {
                    ...
                    if (_meleeStabCritsFiles.Count == 0)
                    {
                        ...
                        var randNo = randomNumber.Next(1, MeleeStabCritsSfxCount);
                ...
                {
                    Random randomNumber = new();
                    var randNo = randomNumber.Next(1, Egg1SfxCount);
            ...
            public override void OnHitNPCWithProj(Projectile proj, NPC target, int damage, float knockback, bool crit)
            {
                ...
                if (crit && projectileCritsEnabled)
                {
                    if (proj.DamageType == DamageClass.Ranged)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, RangedCritsSfxCount);
                    ...
                    if (proj.DamageType == DamageClass.Throwing)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, ThrowingCritsSfxCount);
                    ...
                    if (proj.DamageType == DamageClass.Magic)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, MagicCritsSfxCount);
                    ...
                    if (proj.DamageType == DamageClass.Melee)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, MeleeCritsSfxCount);
                    ...
                    if (proj.DamageType == DamageClass.Summon)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, SummonCritsSfxCount);
                    ...
                    if (proj.DamageType == DamageClass.Generic || proj.DamageType == DamageClass.NoScaling)
                    {
                        ...
                        {
                            Random randomNumber = new();
                            var randNo = randomNumber.Next(1, GenericCritsSfxCount);
